  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {(() => {
            const raw = colors && colors.length ? colors.slice(0, 4) : ['rgba(0,0,0,0.8)', 'rgba(0,0,0,0.5)', 'rgba(0,0,0,0.2)'];
            let arr = [...raw];
            if (arr.length >= 3) {
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 h-full bg-black/95 flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10"
          ...
          <div className="sm-panel-inner flex-1 flex flex-col gap-6">
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              <div className="sm-socials mt-auto pt-8 flex flex-col gap-3" aria-label="Social links">
                <h3 className="sm-socials-title m-0 text-base font-medium [color:var(--sm-accent,#FFFFFF)]">Socials</h3>
                <ul
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: #000000; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6.5em 2.25em 2.25em 2.25em; overflow-y: auto; z-index: 10; }
...
.sm-scope .sm-socials-title { margin: 0; font-size: 1.05rem; font-weight: 500; color: var(--sm-accent, #FFFFFF); }
...
.sm-scope .sm-socials-link:focus-visible { outline: 2px solid var(--sm-accent, #FFFFFF); outline-offset: 3px; }
...
.sm-scope .sm-socials-link:hover { color: var(--sm-accent, #FFFFFF); }
.sm-scope .sm-panel-title { margin: 0; font-size: 1rem; font-weight: 600; color: #FFFFFF; text-transform: uppercase; }
.sm-scope .sm-panel-list { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: 0.75rem; }
.sm-scope .sm-panel-item { position: relative; color: #FFFFFF; font-weight: 600; font-size: 2.1rem; cursor: pointer; line-height: 1.1; letter-spacing: -1px; text-transform: uppercase; transition: background 0.25s, color 0.25s; display: inline-block; text-decoration: none; padding-right: 1.4em; }
...
.sm-scope .sm-panel-item:hover { color: var(--sm-accent, #FFFFFF); }
