export const siteConfig = {
  couple: {
    bride: "Kerseymere Jebb B. Castro",
    brideNickname: "Kersey",
    groom: "Victor Merlean Espinas",
    groomNickname: "Victor",
  },
  wedding: {
    date: "March 19, 2026",
    time: "2:00 PM",
  ...
  ceremony: {
    location: "Capilla De Sta. Rita De Cascia ( Colegio San Agustin, SJDM)",
  ...
  reception: {
    ...
    venue: "Villa Leonora Resort & Event Venue",
    date: "March 19, 2026",
...
Now, as they prepare to say yes before God and the people they love most, Catherine is grateful for the patience, humor, and hope Mark brings to every day. She knows this next chapter is just the start of the love story they get to write together.`,
  ...
  snapShare: {
    googleDriveLink: "https://drive.google.com/drive/folders/1yyuVtVucBVDR2AT0pzRDPyNQ4SYN1SGd?usp=sharing",
    hashtag: "#KerseyAndVictor2026",
